  ...
  if (sorted.length === 0) {
    ...
    sorted.forEach(w => {
      ...
      const imageThumbHTML = w.image 
        ? `<div class="w-12 h-16 rounded overflow-hidden shrink-0 bg-gray-50 border border-gray-100 flex items-center justify-center"><img src="${w.image}" class="object-contain w-full h-full"></div>`
...
function renderArchiveView() {
  ...
  if (sorted.length === 0) {
    ...
    sorted.forEach(w => {
      ...
      const imageThumbHTML = w.image 
        ? `<div class="w-12 h-16 rounded overflow-hidden shrink-0 bg-gray-50 border border-gray-100 opacity-75 flex items-center justify-center"><img src="${w.image}" class="object-contain w-full h-full"></div>`
...
function renderDetailView() {
  ...
  const imageDisplayHTML = wine.image 
    ? `<div class="aspect-[2/3] rounded-xl overflow-hidden shadow-sm border border-gray-100 bg-gray-50 flex items-center justify-center max-w-xs">
        <img src="${wine.image}" alt="${wine.name}" class="object-contain w-full h-full">
       </div>`
    ...
    box.innerHTML = `
      <div class="flex items-center gap-3">
        <div class="w-16 h-20 rounded-lg overflow-hidden border border-gray-200 bg-white shrink-0 flex items-center justify-center">
          <img src="${modalImageUrl}" class="object-contain w-full h-full">
        </div>
