...
const WINES_INITIAL = [
  {
    id:1, name:"Pichon Baron", producer:"Château Pichon Baron",
    vintage:2016, type:"red", region:"Bordeaux", country:"Frankreich",
    alcohol:13.5, grapes:[{name:"Cabernet Sauvignon",pct:65,primary:true},{name:"Merlot",pct:35,primary:false}],
    rating:4.3, reviews:1284, qty:6, price:89, drinkFrom:2022, drinkUntil:2035,
    nutrition:{sugar:2.1,kcal:85,sulfites:120},
    tasting:[
      {user:"WineExpert_DE",r:4.5,note:"Eleganter Bordeaux mit tiefer Cassis-Note und feinen Tanninen. Langer, mineralischer Abgang.",date:"März 2024"},
      {user:"Sommelier_Wien",r:4.1,note:"Klassischer Pauillac-Stil. Schwarze Johannisbeere, Zeder und Bleistift auf der Nase.",date:"Jan 2024"},
    ],
  },
  {
    id:2, name:"Grüner Veltliner Federspiel", producer:"Domäne Wachau",
    vintage:2021, type:"white", region:"Wachau", country:"Österreich",
    alcohol:12.0, grapes:[{name:"Grüner Veltliner",pct:100,primary:true}],
    rating:4.0, reviews:876, qty:12, price:19, drinkFrom:2022, drinkUntil:2027,
    nutrition:{sugar:1.8,kcal:79,sulfites:100},
    tasting:[
      {user:"AustrianWines",r:4.0,note:"Frischer, lebendiger Veltliner mit typischer Pfeffernote und elegantem Zitrusfinish.",date:"Apr 2024"},
    ],
  },
  {
    id:3, name:"Tignanello", producer:"Antinori",
    vintage:2019, type:"red", region:"Toskana", country:"Italien",
    alcohol:14.0, grapes:[{name:"Sangiovese",pct:80,primary:true},{name:"Cab. Sauvignon",pct:15,primary:false},{name:"Cab. Franc",pct:5,primary:false}],
    rating:4.6, reviews:3241, qty:3, price:145, drinkFrom:2024, drinkUntil:2038,
    nutrition:{sugar:2.8,kcal:87,sulfites:130},
    tasting:[
      {user:"TuscanyLover",r:4.7,note:"Monumentaler Tignanello. Veilchen, Kirschen, Leder. Die Tannine sind präzise und seidig.",date:"Mai 2024"},
      {user:"ItalianFine",r:4.5,note:"Kraftvoll und elegant zugleich. Ein Meisterwerk der Supertoskanischen Schule.",date:"März 2024"},
    ],
  },
  {
    id:4, name:"Grand Imperial", producer:"Moët & Chandon",
    vintage:null, type:"sparkling", region:"Champagne", country:"Frankreich",
    alcohol:12.0, grapes:[{name:"Pinot Noir",pct:45,primary:true},{name:"Pinot Meunier",pct:30,primary:false},{name:"Chardonnay",pct:25,primary:false}],
    rating:3.9, reviews:5678, qty:4, price:52, drinkFrom:2024, drinkUntil:2026,
    nutrition:{sugar:9.5,kcal:81,sulfites:95},
    tasting:[
      {user:"ChampagneNerd",r:3.8,note:"Zugänglich, fruchtig, gute Perlage. Für den Anlass absolut passend.",date:"Dez 2023"},
    ],
  },
  {
    id:5, name:"Scharzhofberger Riesling", producer:"Egon Müller",
    vintage:2020, type:"white", region:"Mosel", country:"Deutschland",
    alcohol:8.5, grapes:[{name:"Riesling",pct:100,primary:true}],
    rating:4.8, reviews:412, qty:2, price:320, drinkFrom:2025, drinkUntil:2045,
    nutrition:{sugar:55.0,kcal:73,sulfites:85},
    tasting:[
      {user:"RieslingGott",r:5.0,note:"Atemberaubend. Perfektes Säure-Zucker-Spiel. Schiefermineral, weiße Pfirsiche, unendlicher Abgang.",date:"Jun 2024"},
      {user:"MoselMaestro",r:4.7,note:"Spätlese-Qualität auf Auslese-Niveau. Einer der besten deutschen Weißweine des Jahrzehnts.",date:"Mai 2024"},
    ],
  },
  {
    id:6, name:"Vega Sicilia Unico", producer:"Vega Sicilia",
    vintage:2012, type:"red", region:"Ribera del Duero", country:"Spanien",
    alcohol:14.5, grapes:[{name:"Tempranillo",pct:94,primary:true},{name:"Cab. Sauvignon",pct:6,primary:false}],
    rating:4.9, reviews:821, qty:1, price:395, drinkFrom:2025, drinkUntil:2050,
    nutrition:{sugar:2.2,kcal:91,sulfites:140},
    tasting:[
      {user:"SpanishFinest",r:5.0,note:"Das Unico lebt! Pflaume, Schokolade, Sandelholz, eine Tiefe ohnegleichen. Jahrzehnte Potenzial.",date:"Jul 2024"},
      {user:"RiberaKenner",r:4.8,note:"Monumentales Reifepotenzial. Samtige Tannine, exotische Würze, trockener Langabgang.",date:"Jun 2024"},
    ],
  },
  {
    id:7, name:"Montée de Tonnerre", producer:"William Fèvre",
    vintage:2020, type:"white", region:"Burgund", country:"Frankreich",
    alcohol:13.0, grapes:[{name:"Chardonnay",pct:100,primary:true}],
    rating:4.4, reviews:934, qty:6, price:48, drinkFrom:2023, drinkUntil:2030,
    nutrition:{sugar:1.4,kcal:82,sulfites:105},
    tasting:[
      {user:"BurgundBotschafter",r:4.4,note:"Quintessentieller Chablis – Kreide, grüner Apfel, Austernschale. Straff und vollmundig.",date:"Apr 2024"},
    ],
  },
  {
    id:8, name:"Barolo Brunate", producer:"Giuseppe Rinaldi",
    vintage:2017, type:"red", region:"Piemont", country:"Italien",
    alcohol:14.5, grapes:[{name:"Nebbiolo",pct:100,primary:true}],
    rating:4.7, reviews:563, qty:4, price:130, drinkFrom:2026, drinkUntil:2040,
    nutrition:{sugar:1.6,kcal:89,sulfites:125},
    tasting:[
      {user:"PiemontPassion",r:4.7,note:"Klassischer Traditionsbarolo. Rosen, Teer, Kirschen. Die Tannine brauchen noch Zeit.",date:"März 2024"},
    ],
  },
  {
    id:9, name:"Blanc de Blancs", producer:"Ruinart",
    vintage:null, type:"sparkling", region:"Champagne", country:"Frankreich",
    alcohol:12.5, grapes:[{name:"Chardonnay",pct:100,primary:true}],
    rating:4.2, reviews:2341, qty:6, price:75, drinkFrom:2024, drinkUntil:2027,
    nutrition:{sugar:6.0,kcal:78,sulfites:90},
    tasting:[
      {user:"ChampagneConnoisseur",r:4.2,note:"Elegante Frische, feine Perlage, Limette und Brioche. Benchmark für Blanc de Blancs.",date:"Jan 2024"},
    ],
  },
  {
    id:10, name:"Château Margaux", producer:"Château Margaux",
    vintage:2015, type:"red", region:"Bordeaux", country:"Frankreich",
    alcohol:13.0, grapes:[{name:"Cab. Sauvignon",pct:88,primary:true},{name:"Petit Verdot",pct:6,primary:false},{name:"Merlot",pct:4,primary:false},{name:"Cab. Franc",pct:2,primary:false}],
    rating:4.9, reviews:2890, qty:2, price:680, drinkFrom:2025, drinkUntil:2055,
    nutrition:{sugar:1.9,kcal:84,sulfites:135},
    tasting:[
      {user:"BordeauxKritiker",r:5.0,note:"Perfektion in Flaschenform. Veilchen, frische Cassis, ein Hauch Zeder. Der 2015er ist ein Jahrhundert-Margaux.",date:"Jun 2024"},
    ],
  },
  {
    id:11, name:"Gewürztraminer VT", producer:"Trimbach",
    vintage:2016, type:"white", region:"Elsass", country:"Frankreich",
    alcohol:11.5, grapes:[{name:"Gewürztraminer",pct:100,primary:true}],
    rating:4.3, reviews:287, qty:3, price:55, drinkFrom:2022, drinkUntil:2030,
    nutrition:{sugar:45.0,kcal:110,sulfites:95},
    tasting:[
      {user:"AlsaceFanDE",r:4.3,note:"Litschi, Rosenblüte und frische Ingwerwürze. Süß aber mit lebendiger Säure ausbalanciert.",date:"Feb 2024"},
    ],
  },
  {
    id:12, name:"Smaragd Ried Kellerberg", producer:"F.X. Pichler",
    vintage:2018, type:"white", region:"Wachau", country:"Österreich",
    alcohol:13.5, grapes:[{name:"Grüner Veltliner",pct:100,primary:true}],
    rating:4.6, reviews:341, qty:4, price:78, drinkFrom:2022, drinkUntil:2033,
    nutrition:{sugar:2.3,kcal:86,sulfites:110},
    tasting:[
      {user:"WachauWatcher",r:4.6,note:"F.X. Pichlers Kellerberg ist ein Monument. Cremig, kraftvoll, mit enormer Mineralität.",date:"Mai 2024"},
    ],
  },
];
